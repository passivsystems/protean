...
(defn- usage-hud [options-summary]
  (->> [""
        ...
        "                              doc -f public/examples/petstore/petstore.cod.edn"
        ""
        ...
        "                              test -f public/examples/petstore/petstore.cod.edn"
        "                              test -f public/examples/petstore/petstore.cod.edn -b '{\"seed\": {\"tokenValue\": \"VALID_TOKEN\"}}'"
        ""
        "  sim                     -d /path/to/codex"
