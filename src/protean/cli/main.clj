...
(defn- usage-hud [options-summary]
  (->> [""
        ...
        ""
        "  sim                     -d /path/to/codex"
        "                             e.g. To start a free happy path sim server for mycodex.cod.edn"
        "                               sim -d /path/to/mycodex"
        ""
        "  build                   -f codex"
        "                             e.g. To build a stateful sim with conversational capabilities"
        "                               build -f sample-petstore.cod.edn"
        ""
