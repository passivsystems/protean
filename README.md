...
* Latest development release is 0.9.0-alpha.3
    * [Code](https://github.com/passivsystems/protean/tree/0.9.0-alpha.3)
    * [Download](https://github.com/passivsystems/protean/releases/download/0.9.0-alpha.1/protean-0.9.0-alpha.3.tgz)
